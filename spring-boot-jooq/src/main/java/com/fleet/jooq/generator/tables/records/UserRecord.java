...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record2<UInteger, String> {
    ...
    private static final long serialVersionUID = 1390622021;

    /**
     * Setter for <code>fleet-test.user.id</code>. 用户标识
     */
    ...
    /**
     * Getter for <code>fleet-test.user.id</code>. 用户标识
     */
    ...
    /**
     * Setter for <code>fleet-test.user.name</code>. 工号（登录使用）
     */
    ...
    /**
     * Getter for <code>fleet-test.user.name</code>. 工号（登录使用）
     */
